  ...
  return (
    <main style={{ padding: 20, display: "grid", gap: 10 }}>
      <section className="auth-card w-full" style={{ justifySelf: "center", justifyItems: "center", minHeight: "500px", padding: "32px", maxWidth: "640px", width: "100%" }}>
        <h2 className="content-title" style={{ marginBottom: 30 }}>Create your account</h2>
        ...
        <div className="space-y-2" style={{ width: "100%" }}>
          <h3 className="text-sm text-slate-600" style={{ fontSize: "20px", fontWeight: 600, marginBottom: "15px" }}>Create with email</h3>
          <div className="auth-row">
          ...
          <button className="brand-btn auth-primary" disabled={busy} onClick={() => void createWithEmail()} style={{ marginTop: "20px", marginBottom: "30px" }}>
            {busy ? "Creating…" : "Create account"}
          </button>
        </div>

        {/* <div className="mt-6 mb-4">
          <p className="text-center text-slate-600" style={{ marginTop: "50px", marginBottom: "15px" }}>or continue with</p>
        </div> */}
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
              <button
                type="button"
                disabled={busy}
                onClick={() => void createWithProvider(googleProvider)}
